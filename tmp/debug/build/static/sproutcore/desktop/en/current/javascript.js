    ...
    childViews: [
      SC.View.extend(SC.StaticLayout, {
        ...
        render: function(context, firstTime) {
          ...
          var blank = '/static/sproutcore/foundation/en/current/blank.gif?1249464889' ;
...
/** @scope SC.MenuItemView.prototype */{
  ...
  */
  renderImage: function(context, image) {
    ...
    if (image && SC.ImageView.valueIsUrl(image)) {
      ...
      className = image ;
      url = '/static/sproutcore/foundation/en/current/blank.gif?1249464889' ; 
    }
  ...
  */
  ...
  renderBranch: function(context, hasBranch) {
    ...
    var a = '>' ;
    var url = '/static/sproutcore/foundation/en/current/blank.gif?1249464889' ;
  ...
  render: function(context, firstTime) {
    ...
    if (firstTime) {
      ...
      for(idx=0;idx<itemsLength;idx++) {
        ...
        icon = item[3];
        if (icon) {
          url = (icon.indexOf('/')>=0) ? icon : '/static/sproutcore/foundation/en/current/blank.gif?1249464889';
        ...
        var blankImage = '/static/sproutcore/foundation/en/current/blank.gif?1249464889';
...
/** @scope SC.SourceListGroupView.prototoype */ {
  ...
  */
  ...
  render: function(context, firstTime) {
    ...
    context.push('<img src="%@" class="button" />'.fmt('/static/sproutcore/foundation/en/current/blank.gif?1249464889')) ;
